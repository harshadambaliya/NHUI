...
$layout = kingstrox_set( $_GET, 'layout' ) ? $_GET['layout'] : $layout; 
if(kingstrox_set($_GET, 'layout_style')) $layout = kingstrox_set($_GET, 'layout_style'); else

$layout = kingstrox_set( $meta, 'layout');
$sidebar = kingstrox_set( $meta, 'sidebar');

$layout = ($layout) ? $layout : kingstrox_set($options, 'woo_cat_page_layout');
$sidebar = ($sidebar) ? $sidebar : kingstrox_set($options, 'woocommerce_cat_page_sidebar');

if( !$layout || $layout == 'full' || kingstrox_set($_GET, 'layout_style')=='full' ) $classes[] = 'shop-item col-md-3 col-sm-6 col-xs-12'; else $classes[] = 'shop-item col-lg-4 col-md-6 col-sm-6 col-xs-12'; 
//$pro_num = kingstrox_set($options, 'number_of_product_column');
